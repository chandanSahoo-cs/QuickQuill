...
import { GitCompareIcon, HistoryIcon, X } from "lucide-react"
...
type ViewMode = "history" | "diff"

export const VersionControlModal = ({ isOpen, onClose, data }: VersionControlModalProps) => {
      ...
      <DialogContent className="max-w-[95vw] max-h-[95vh] h-[95vh] w-[95vw] p-0 bg-white border-slate-200 overflow-hidden">
        ...
        >
          ...
          <div className="flex-1 overflow-hidden bg-slate-50">
            {viewMode === "history" && <History data={data} onClose={onClose} />}
            {viewMode === "diff" && (
              <motion.div
              ...
              >
                <div className="text-center">
                  ...
                  <h3 className="text-lg font-semibold text-slate-700 mb-2">Compare Versions</h3>
                  <p className="text-slate-500 max-w-md">
                    Diff functionality will be available soon. You can compare different versions of your document here.
                  </p>
                </div>
              </motion.div>
            )}
