...
export const History = ({ data, onClose }: HistoryProps) => {
  ...
  const onRestore = async () => {
    ...
    try {
      ...
      const success = editor?.commands.setContent(content as EditorJSON);
      if (success) {
            ...
            <div className="flex-1">
              <div className="p-8">
                <ReadOnlyEditor
                  ...
                  className="overflow-y-auto scrollbar-thin scrollbar-thumb-gray-300 scrollbar-track-transparent scrollbar-hide h-[420px]"
                />
              </div>
            </div>
          </>
